...
hoistedDependencies:
  ...
  jest-circus@28.1.3:
    jest-circus: private
  jest-cli@28.1.3(@types/node@22.7.4):
    jest-cli: private
  jest-config@28.1.3(@types/node@22.7.4):
    jest-config: private
  jest-diff@28.1.3:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Sun, 29 Sep 2024 04:29:33 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  - fsevents@2.3.3
storeDir: /home/trioadhi/.local/share/pnpm/store/v3
